...
protected:
	[[nodiscard]] bool isEmpty(const std::string_view str) const;
	...
	[[nodiscard]] bool containsAlphaCharacter(const std::string_view str) const;

	[[nodiscard]] bool containsDigit(const std::string_view category) const;

	[[nodiscard]] bool containsSpecialCharacter(const std::string_view str) const;
};

class NameValidator : public StringValidator {
public:
	[[nodiscard]] bool isValid(const std::string_view name) const;
...
public:
	[[nodiscard]] bool isValid(const std::string_view category) const;
